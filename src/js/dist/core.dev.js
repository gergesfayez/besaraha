...
var navbar = document.getElementById("navbar"); //var sponserLeft = document.getElementById("stick-l");
...
function stickyEl() {
  ...
  if (state === 1 && window.pageYOffset >= sticky) {
    state = 2;
    navbar.classList.add("sticky"); //   sponserLeft.classList.add("stickyL");
    //   sponserRight.classList.add("stickyR");
  } else if (state === 2 && window.pageYOffset < sticky) {
    state = 1;
    navbar.classList.remove("sticky"); //  sponserLeft.classList.remove("stickyL");
